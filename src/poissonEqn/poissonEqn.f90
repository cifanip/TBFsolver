...
! ************************************************************************************** !
! This subroutine is based on the work: Cifani, P., 2019. Analysis of a constant-coefficient 
! pressure equation method for fast computations of two-phase flows at high density ratios,
