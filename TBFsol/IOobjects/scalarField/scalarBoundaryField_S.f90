...
!========================================================================================!
	subroutine scalarBoundaryFieldCTOR(this,f,bNumber,readBC)
		type(scalarBoundaryField) :: this
...
!========================================================================================!
    subroutine initDeafaultBoundaryField(this,f,bNumber)
        type(scalarBoundaryField), intent(inout) :: this
        type(scalarField), intent(in) :: f
        integer, intent(in) :: bNumber
...
!========================================================================================!
    subroutine decomposeBoundaryPatch(this,p,ptrMPIC,patchDir,patchCoordIndex)
        type(scalarBoundaryField), intent(in) :: this
        type(scalarBoundaryField), intent(inout) :: p
...
!========================================================================================!
   subroutine coarsenBoundary(this,fc,mc,tp)
        type(scalarBoundaryField), intent(in) :: this		!fine field
		type(scalarBoundaryField), intent(inout) :: fc		!coarse field
